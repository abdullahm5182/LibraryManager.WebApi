...
namespace LibraryManager.Application.DTOs.Request
{
    public class BookSaveRequestDTO
    {
        ...
        [StringLength(255, MinimumLength = 1, ErrorMessage = "Title must be between 2 and 255 characters.")] 
        public string? Title { get; set; }
        [Required(ErrorMessage = "Author First Name is required.")]
        [StringLength(100, MinimumLength = 1, ErrorMessage = "Author First Name must be between 2 and 100 characters.")] 
        public string? AuthorFirstName { get; set; }
        [Required(ErrorMessage = "Author Last Name is required.")]
        [StringLength(100, MinimumLength = 1, ErrorMessage = "Author Last Name must be between 2 and 100 characters.")] 
        public string? AuthorLastName { get; set; }
        [Required(ErrorMessage = "Publisher is required.")]
        [StringLength(255, MinimumLength = 1, ErrorMessage = "Publisher must be between 2 and 255 characters.")] 
